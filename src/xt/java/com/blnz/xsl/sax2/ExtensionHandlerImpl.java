...
import com.blnz.xsl.tr.ExtensionHandler;
import com.blnz.xsl.tr.Result;
import com.blnz.xsl.tr.ResultFragmentVariant;
import com.blnz.xsl.tr.ResultFragmentVariantBase;
...
public class ExtensionHandlerImpl implements ExtensionHandler 
{
    ...
    public Object wrapResultFragmentVariant(final ResultFragmentVariant frag)
    {
        return new ResultTreeFragment()
            {
                public void emit(ContentHandler handler) throws SAXException
                {
