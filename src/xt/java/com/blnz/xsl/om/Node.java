...
public interface Node extends SourceLocator
{
     ...
     * @return ?? -1 if precedes, +1 if follows?
     */
    ...
    /**
     *  returns a NodeExtension object tied to this Node, if present. Otherwise, null
     */
    NodeExtension getNodeExtension();
}
